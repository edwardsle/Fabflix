...
public class MovieListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
				...
				String query = "SELECT * FROM (movies INNER JOIN ratings ON ratings.movieId = movies.id) " + whereQ + " " +sortQ + " " + pageQ;
				String queryToCount = "SELECT count(*) as c FROM (movies INNER JOIN ratings ON ratings.movieId = movies.id) " + whereQ + " " +sortQ;
